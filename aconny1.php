    ...
    if (isset($_POST['submit'])) {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            try {
                ...
                $mail->SMTPAuth   = true;
                $mail->Username   = 'solomonjulius96@gmail.com';
                $mail->Password   = 'gfgulxxuonhqzbjj';
                ...
                // Email content
                $mail->setFrom('solomonjulius96@gmail.com', 'Julius');
                $mail->addAddress($email, 'Recipient Name'); 
                //$mail->addAddress('solomonjulius96@gmail.com', 'Dear solomon');
                $mail->isHTML(true);
                $mail->Subject = 'Loan Application Submitted';
                $mail->Body    = 'Your loan application has been submitted successfully. Your username is: ' . $username;
